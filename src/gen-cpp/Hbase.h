...
class HbaseCobClient;

class HbaseCobClIf {
 public:
  virtual ~HbaseCobClIf() {}
  virtual void enableTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableName) = 0;
  virtual void disableTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableName) = 0;
  virtual void isTableEnabled(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableName) = 0;
  virtual void compact(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableNameOrRegionName) = 0;
  virtual void majorCompact(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableNameOrRegionName) = 0;
  virtual void getTableNames(std::tr1::function<void(HbaseCobClient* client)> cob) = 0;
  virtual void getColumnDescriptors(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName) = 0;
  virtual void getTableRegions(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName) = 0;
  virtual void createTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<ColumnDescriptor> & columnFamilies) = 0;
  virtual void deleteTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName) = 0;
  virtual void get(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column) = 0;
  virtual void getVer(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int32_t numVersions) = 0;
  virtual void getVerTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const int32_t numVersions) = 0;
  virtual void getRow(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row) = 0;
  virtual void getRowWithColumns(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Text> & columns) = 0;
  virtual void getRowTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const int64_t timestamp) = 0;
  virtual void getRowWithColumnsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void getRows(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows) = 0;
  virtual void getRowsWithColumns(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns) = 0;
  virtual void getRowsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows, const int64_t timestamp) = 0;
  virtual void getRowsWithColumnsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void mutateRow(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Mutation> & mutations) = 0;
  virtual void mutateRowTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const int64_t timestamp) = 0;
  virtual void mutateRows(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<BatchMutation> & rowBatches) = 0;
  virtual void mutateRowsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<BatchMutation> & rowBatches, const int64_t timestamp) = 0;
  virtual void atomicIncrement(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int64_t value) = 0;
  virtual void deleteAll(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column) = 0;
  virtual void deleteAllTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp) = 0;
  virtual void deleteAllRow(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row) = 0;
  virtual void deleteAllRowTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const int64_t timestamp) = 0;
  virtual void scannerOpen(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const std::vector<Text> & columns) = 0;
  virtual void scannerOpenWithStop(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns) = 0;
  virtual void scannerOpenWithPrefix(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startAndPrefix, const std::vector<Text> & columns) = 0;
  virtual void scannerOpenTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void scannerOpenWithStopTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void scannerGet(std::tr1::function<void(HbaseCobClient* client)> cob, const ScannerID id) = 0;
  virtual void scannerGetList(std::tr1::function<void(HbaseCobClient* client)> cob, const ScannerID id, const int32_t nbRows) = 0;
  virtual void scannerClose(std::tr1::function<void(HbaseCobClient* client)> cob, const ScannerID id) = 0;
};

class HbaseCobSvIf {
 public:
  virtual ~HbaseCobSvIf() {}
  virtual void enableTable(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Bytes& tableName) = 0;
  virtual void disableTable(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Bytes& tableName) = 0;
  virtual void isTableEnabled(std::tr1::function<void(bool const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Bytes& tableName) = 0;
  virtual void compact(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Bytes& tableNameOrRegionName) = 0;
  virtual void majorCompact(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Bytes& tableNameOrRegionName) = 0;
  virtual void getTableNames(std::tr1::function<void(std::vector<Text>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */) = 0;
  virtual void getColumnDescriptors(std::tr1::function<void(std::map<Text, ColumnDescriptor>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName) = 0;
  virtual void getTableRegions(std::tr1::function<void(std::vector<TRegionInfo>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName) = 0;
  virtual void createTable(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<ColumnDescriptor> & columnFamilies) = 0;
  virtual void deleteTable(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName) = 0;
  virtual void get(std::tr1::function<void(std::vector<TCell>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const Text& column) = 0;
  virtual void getVer(std::tr1::function<void(std::vector<TCell>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const Text& column, const int32_t numVersions) = 0;
  virtual void getVerTs(std::tr1::function<void(std::vector<TCell>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const int32_t numVersions) = 0;
  virtual void getRow(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row) = 0;
  virtual void getRowWithColumns(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const std::vector<Text> & columns) = 0;
  virtual void getRowTs(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const int64_t timestamp) = 0;
  virtual void getRowWithColumnsTs(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void getRows(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<Text> & rows) = 0;
  virtual void getRowsWithColumns(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns) = 0;
  virtual void getRowsTs(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<Text> & rows, const int64_t timestamp) = 0;
  virtual void getRowsWithColumnsTs(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void mutateRow(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const std::vector<Mutation> & mutations) = 0;
  virtual void mutateRowTs(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const int64_t timestamp) = 0;
  virtual void mutateRows(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<BatchMutation> & rowBatches) = 0;
  virtual void mutateRowsTs(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const std::vector<BatchMutation> & rowBatches, const int64_t timestamp) = 0;
  virtual void atomicIncrement(std::tr1::function<void(int64_t const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const Text& column, const int64_t value) = 0;
  virtual void deleteAll(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const Text& column) = 0;
  virtual void deleteAllTs(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp) = 0;
  virtual void deleteAllRow(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row) = 0;
  virtual void deleteAllRowTs(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& row, const int64_t timestamp) = 0;
  virtual void scannerOpen(std::tr1::function<void(ScannerID const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& startRow, const std::vector<Text> & columns) = 0;
  virtual void scannerOpenWithStop(std::tr1::function<void(ScannerID const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns) = 0;
  virtual void scannerOpenWithPrefix(std::tr1::function<void(ScannerID const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& startAndPrefix, const std::vector<Text> & columns) = 0;
  virtual void scannerOpenTs(std::tr1::function<void(ScannerID const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void scannerOpenWithStopTs(std::tr1::function<void(ScannerID const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const int64_t timestamp) = 0;
  virtual void scannerGet(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const ScannerID id) = 0;
  virtual void scannerGetList(std::tr1::function<void(std::vector<TRowResult>  const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const ScannerID id, const int32_t nbRows) = 0;
  virtual void scannerClose(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const ScannerID id) = 0;
};

class HbaseCobSvIfFactory {
 public:
  typedef HbaseCobSvIf Handler;

  virtual ~HbaseCobSvIfFactory() {}

  virtual HbaseCobSvIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) = 0;
  virtual void releaseHandler(HbaseCobSvIf* /* handler */) = 0;
};

class HbaseCobSvIfSingletonFactory : virtual public HbaseCobSvIfFactory {
 public:
  HbaseCobSvIfSingletonFactory(const boost::shared_ptr<HbaseCobSvIf>& iface) : iface_(iface) {}
  virtual ~HbaseCobSvIfSingletonFactory() {}

  virtual HbaseCobSvIf* getHandler(const ::apache::thrift::TConnectionInfo&) {
    return iface_.get();
  }
  virtual void releaseHandler(HbaseCobSvIf* /* handler */) {}

 protected:
  boost::shared_ptr<HbaseCobSvIf> iface_;
};

class HbaseCobSvNull : virtual public HbaseCobSvIf {
 public:
  virtual ~HbaseCobSvNull() {}
...
class HbaseCobClient : virtual public HbaseCobClIf {
 public:
  HbaseCobClient(boost::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void enableTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableName);
  void send_enableTable(const Bytes& tableName);
  void recv_enableTable();
  void disableTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableName);
  void send_disableTable(const Bytes& tableName);
  void recv_disableTable();
  void isTableEnabled(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableName);
  void send_isTableEnabled(const Bytes& tableName);
  bool recv_isTableEnabled();
  void compact(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableNameOrRegionName);
  void send_compact(const Bytes& tableNameOrRegionName);
  void recv_compact();
  void majorCompact(std::tr1::function<void(HbaseCobClient* client)> cob, const Bytes& tableNameOrRegionName);
  void send_majorCompact(const Bytes& tableNameOrRegionName);
  void recv_majorCompact();
  void getTableNames(std::tr1::function<void(HbaseCobClient* client)> cob);
  void send_getTableNames();
  void recv_getTableNames(std::vector<Text> & _return);
  void getColumnDescriptors(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName);
  void send_getColumnDescriptors(const Text& tableName);
  void recv_getColumnDescriptors(std::map<Text, ColumnDescriptor> & _return);
  void getTableRegions(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName);
  void send_getTableRegions(const Text& tableName);
  void recv_getTableRegions(std::vector<TRegionInfo> & _return);
  void createTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<ColumnDescriptor> & columnFamilies);
  void send_createTable(const Text& tableName, const std::vector<ColumnDescriptor> & columnFamilies);
  void recv_createTable();
  void deleteTable(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName);
  void send_deleteTable(const Text& tableName);
  void recv_deleteTable();
  void get(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column);
  void send_get(const Text& tableName, const Text& row, const Text& column);
  void recv_get(std::vector<TCell> & _return);
  void getVer(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int32_t numVersions);
  void send_getVer(const Text& tableName, const Text& row, const Text& column, const int32_t numVersions);
  void recv_getVer(std::vector<TCell> & _return);
  void getVerTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const int32_t numVersions);
  void send_getVerTs(const Text& tableName, const Text& row, const Text& column, const int64_t timestamp, const int32_t numVersions);
  void recv_getVerTs(std::vector<TCell> & _return);
  void getRow(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row);
  void send_getRow(const Text& tableName, const Text& row);
  void recv_getRow(std::vector<TRowResult> & _return);
  void getRowWithColumns(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Text> & columns);
  void send_getRowWithColumns(const Text& tableName, const Text& row, const std::vector<Text> & columns);
  void recv_getRowWithColumns(std::vector<TRowResult> & _return);
  void getRowTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const int64_t timestamp);
  void send_getRowTs(const Text& tableName, const Text& row, const int64_t timestamp);
  void recv_getRowTs(std::vector<TRowResult> & _return);
  void getRowWithColumnsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Text> & columns, const int64_t timestamp);
  void send_getRowWithColumnsTs(const Text& tableName, const Text& row, const std::vector<Text> & columns, const int64_t timestamp);
  void recv_getRowWithColumnsTs(std::vector<TRowResult> & _return);
  void getRows(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows);
  void send_getRows(const Text& tableName, const std::vector<Text> & rows);
  void recv_getRows(std::vector<TRowResult> & _return);
  void getRowsWithColumns(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns);
  void send_getRowsWithColumns(const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns);
  void recv_getRowsWithColumns(std::vector<TRowResult> & _return);
  void getRowsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows, const int64_t timestamp);
  void send_getRowsTs(const Text& tableName, const std::vector<Text> & rows, const int64_t timestamp);
  void recv_getRowsTs(std::vector<TRowResult> & _return);
  void getRowsWithColumnsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const int64_t timestamp);
  void send_getRowsWithColumnsTs(const Text& tableName, const std::vector<Text> & rows, const std::vector<Text> & columns, const int64_t timestamp);
  void recv_getRowsWithColumnsTs(std::vector<TRowResult> & _return);
  void mutateRow(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Mutation> & mutations);
  void send_mutateRow(const Text& tableName, const Text& row, const std::vector<Mutation> & mutations);
  void recv_mutateRow();
  void mutateRowTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const int64_t timestamp);
  void send_mutateRowTs(const Text& tableName, const Text& row, const std::vector<Mutation> & mutations, const int64_t timestamp);
  void recv_mutateRowTs();
  void mutateRows(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<BatchMutation> & rowBatches);
  void send_mutateRows(const Text& tableName, const std::vector<BatchMutation> & rowBatches);
  void recv_mutateRows();
  void mutateRowsTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const std::vector<BatchMutation> & rowBatches, const int64_t timestamp);
  void send_mutateRowsTs(const Text& tableName, const std::vector<BatchMutation> & rowBatches, const int64_t timestamp);
  void recv_mutateRowsTs();
  void atomicIncrement(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int64_t value);
  void send_atomicIncrement(const Text& tableName, const Text& row, const Text& column, const int64_t value);
  int64_t recv_atomicIncrement();
  void deleteAll(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column);
  void send_deleteAll(const Text& tableName, const Text& row, const Text& column);
  void recv_deleteAll();
  void deleteAllTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const Text& column, const int64_t timestamp);
  void send_deleteAllTs(const Text& tableName, const Text& row, const Text& column, const int64_t timestamp);
  void recv_deleteAllTs();
  void deleteAllRow(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row);
  void send_deleteAllRow(const Text& tableName, const Text& row);
  void recv_deleteAllRow();
  void deleteAllRowTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& row, const int64_t timestamp);
  void send_deleteAllRowTs(const Text& tableName, const Text& row, const int64_t timestamp);
  void recv_deleteAllRowTs();
  void scannerOpen(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const std::vector<Text> & columns);
  void send_scannerOpen(const Text& tableName, const Text& startRow, const std::vector<Text> & columns);
  ScannerID recv_scannerOpen();
  void scannerOpenWithStop(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns);
  void send_scannerOpenWithStop(const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns);
  ScannerID recv_scannerOpenWithStop();
  void scannerOpenWithPrefix(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startAndPrefix, const std::vector<Text> & columns);
  void send_scannerOpenWithPrefix(const Text& tableName, const Text& startAndPrefix, const std::vector<Text> & columns);
  ScannerID recv_scannerOpenWithPrefix();
  void scannerOpenTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const int64_t timestamp);
  void send_scannerOpenTs(const Text& tableName, const Text& startRow, const std::vector<Text> & columns, const int64_t timestamp);
  ScannerID recv_scannerOpenTs();
  void scannerOpenWithStopTs(std::tr1::function<void(HbaseCobClient* client)> cob, const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const int64_t timestamp);
  void send_scannerOpenWithStopTs(const Text& tableName, const Text& startRow, const Text& stopRow, const std::vector<Text> & columns, const int64_t timestamp);
  ScannerID recv_scannerOpenWithStopTs();
  void scannerGet(std::tr1::function<void(HbaseCobClient* client)> cob, const ScannerID id);
  void send_scannerGet(const ScannerID id);
  void recv_scannerGet(std::vector<TRowResult> & _return);
  void scannerGetList(std::tr1::function<void(HbaseCobClient* client)> cob, const ScannerID id, const int32_t nbRows);
  void send_scannerGetList(const ScannerID id, const int32_t nbRows);
  void recv_scannerGetList(std::vector<TRowResult> & _return);
  void scannerClose(std::tr1::function<void(HbaseCobClient* client)> cob, const ScannerID id);
  void send_scannerClose(const ScannerID id);
  void recv_scannerClose();
 protected:
...
class HbaseAsyncProcessor : public ::apache::thrift::TAsyncProcessor {
 protected:
  boost::shared_ptr<HbaseCobSvIf> iface_;
 ...
 private:
  std::map<std::string, void (HbaseAsyncProcessor::*)(std::tr1::function<void(bool ok)>, int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*)> processMap_;
  void process_enableTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_enableTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_enableTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_disableTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_disableTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_disableTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_isTableEnabled(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_isTableEnabled(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const bool& _return);
  void throw_isTableEnabled(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_compact(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_compact(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_compact(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_majorCompact(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_majorCompact(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_majorCompact(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getTableNames(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getTableNames(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<Text> & _return);
  void throw_getTableNames(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getColumnDescriptors(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getColumnDescriptors(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<Text, ColumnDescriptor> & _return);
  void throw_getColumnDescriptors(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getTableRegions(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getTableRegions(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRegionInfo> & _return);
  void throw_getTableRegions(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_createTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_createTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_createTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_deleteTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_deleteTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_deleteTable(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_get(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_get(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TCell> & _return);
  void throw_get(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getVer(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getVer(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TCell> & _return);
  void throw_getVer(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getVerTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getVerTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TCell> & _return);
  void throw_getVerTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRowWithColumns(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRowWithColumns(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRowWithColumns(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRowWithColumnsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRowWithColumnsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRowWithColumnsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRows(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRows(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRows(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRowsWithColumns(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRowsWithColumns(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRowsWithColumns(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRowsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRowsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRowsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_getRowsWithColumnsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_getRowsWithColumnsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_getRowsWithColumnsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_mutateRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_mutateRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_mutateRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_mutateRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_mutateRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_mutateRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_mutateRows(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_mutateRows(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_mutateRows(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_mutateRowsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_mutateRowsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_mutateRowsTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_atomicIncrement(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_atomicIncrement(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int64_t& _return);
  void throw_atomicIncrement(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_deleteAll(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_deleteAll(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_deleteAll(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_deleteAllTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_deleteAllTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_deleteAllTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_deleteAllRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_deleteAllRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_deleteAllRow(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_deleteAllRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_deleteAllRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_deleteAllRowTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerOpen(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerOpen(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const ScannerID& _return);
  void throw_scannerOpen(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerOpenWithStop(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerOpenWithStop(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const ScannerID& _return);
  void throw_scannerOpenWithStop(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerOpenWithPrefix(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerOpenWithPrefix(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const ScannerID& _return);
  void throw_scannerOpenWithPrefix(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerOpenTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerOpenTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const ScannerID& _return);
  void throw_scannerOpenTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerOpenWithStopTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerOpenWithStopTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const ScannerID& _return);
  void throw_scannerOpenWithStopTs(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerGet(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerGet(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_scannerGet(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerGetList(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerGetList(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<TRowResult> & _return);
  void throw_scannerGetList(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void process_scannerClose(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void return_scannerClose(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_scannerClose(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
 public:
  HbaseAsyncProcessor(boost::shared_ptr<HbaseCobSvIf> iface) :
    iface_(iface) {
    processMap_["enableTable"] = &HbaseAsyncProcessor::process_enableTable;
    processMap_["disableTable"] = &HbaseAsyncProcessor::process_disableTable;
    processMap_["isTableEnabled"] = &HbaseAsyncProcessor::process_isTableEnabled;
    processMap_["compact"] = &HbaseAsyncProcessor::process_compact;
    processMap_["majorCompact"] = &HbaseAsyncProcessor::process_majorCompact;
    processMap_["getTableNames"] = &HbaseAsyncProcessor::process_getTableNames;
    processMap_["getColumnDescriptors"] = &HbaseAsyncProcessor::process_getColumnDescriptors;
    processMap_["getTableRegions"] = &HbaseAsyncProcessor::process_getTableRegions;
    processMap_["createTable"] = &HbaseAsyncProcessor::process_createTable;
    processMap_["deleteTable"] = &HbaseAsyncProcessor::process_deleteTable;
    processMap_["get"] = &HbaseAsyncProcessor::process_get;
    processMap_["getVer"] = &HbaseAsyncProcessor::process_getVer;
    processMap_["getVerTs"] = &HbaseAsyncProcessor::process_getVerTs;
    processMap_["getRow"] = &HbaseAsyncProcessor::process_getRow;
    processMap_["getRowWithColumns"] = &HbaseAsyncProcessor::process_getRowWithColumns;
    processMap_["getRowTs"] = &HbaseAsyncProcessor::process_getRowTs;
    processMap_["getRowWithColumnsTs"] = &HbaseAsyncProcessor::process_getRowWithColumnsTs;
    processMap_["getRows"] = &HbaseAsyncProcessor::process_getRows;
    processMap_["getRowsWithColumns"] = &HbaseAsyncProcessor::process_getRowsWithColumns;
    processMap_["getRowsTs"] = &HbaseAsyncProcessor::process_getRowsTs;
    processMap_["getRowsWithColumnsTs"] = &HbaseAsyncProcessor::process_getRowsWithColumnsTs;
    processMap_["mutateRow"] = &HbaseAsyncProcessor::process_mutateRow;
    processMap_["mutateRowTs"] = &HbaseAsyncProcessor::process_mutateRowTs;
    processMap_["mutateRows"] = &HbaseAsyncProcessor::process_mutateRows;
    processMap_["mutateRowsTs"] = &HbaseAsyncProcessor::process_mutateRowsTs;
    processMap_["atomicIncrement"] = &HbaseAsyncProcessor::process_atomicIncrement;
    processMap_["deleteAll"] = &HbaseAsyncProcessor::process_deleteAll;
    processMap_["deleteAllTs"] = &HbaseAsyncProcessor::process_deleteAllTs;
    processMap_["deleteAllRow"] = &HbaseAsyncProcessor::process_deleteAllRow;
    processMap_["deleteAllRowTs"] = &HbaseAsyncProcessor::process_deleteAllRowTs;
    processMap_["scannerOpen"] = &HbaseAsyncProcessor::process_scannerOpen;
    processMap_["scannerOpenWithStop"] = &HbaseAsyncProcessor::process_scannerOpenWithStop;
    processMap_["scannerOpenWithPrefix"] = &HbaseAsyncProcessor::process_scannerOpenWithPrefix;
    processMap_["scannerOpenTs"] = &HbaseAsyncProcessor::process_scannerOpenTs;
    processMap_["scannerOpenWithStopTs"] = &HbaseAsyncProcessor::process_scannerOpenWithStopTs;
    processMap_["scannerGet"] = &HbaseAsyncProcessor::process_scannerGet;
    processMap_["scannerGetList"] = &HbaseAsyncProcessor::process_scannerGetList;
    processMap_["scannerClose"] = &HbaseAsyncProcessor::process_scannerClose;
  }
  ...
  virtual ~HbaseAsyncProcessor() {}
};

class HbaseAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  HbaseAsyncProcessorFactory(const ::boost::shared_ptr< HbaseCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< HbaseCobSvIfFactory > handlerFactory_;
};
